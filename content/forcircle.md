...
## 抽選
直接参加申込が多数の場合、抽選にて直接参加するサークルを決定いたします。基本的には抽選を行いますが、直接頒布か委託頒布かを考慮する場合がございます。抽選が行われた際は、10月初旬に抽選結果を、直接参加申込を行った各サーfクルの申込時に入力したメールアドレスに送信いたします。なお、抽選後の調整により繰り上げ当選を行う場合があります。
